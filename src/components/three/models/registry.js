...
export const models = [
  {
    ...
    presets: {
      default: { position: [7, 5, 8],   target: [0, 4, 0] },
      front:   { position: [0, 4.5, 10], target: [0, 4, 0] },
    },
    load: () => import('./ModelA'),
    controls: ['showShower'],
  ...
  },
  {
    ...
    presets: {
      default: { position: [9, 5.5, 10],  target: [0, 4, 0] },
      front:   { position: [0, 4.5, 13],   target: [0, 4, 0] },
      corner:  { position: [11, 5.5, 11],  target: [0, 4, 0] },
