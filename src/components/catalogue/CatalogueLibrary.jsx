...
export default function CatalogueLibrary() {
  ...
  return (
    <section id="catalogue" className="catalogue-library" aria-labelledby="catalogue-heading">
      <div className="catalogue-container">
        ...
        <div className="catalogue-books" aria-label="Choose a catalogue">
          {catalogues.map((item, index) => <div key={item.id} className={`catalogue-book ${book.id === item.id ? 'is-selected' : ''}`}>
            ...
            <a href={`/catalogues/${item.id}/`} aria-label={`${item.title}: collection details and page index`}>Collection details <span aria-hidden="true">↗</span></a>
          </div>)}
        </div>
