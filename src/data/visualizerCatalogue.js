...
// Used only by Visualizer and ZonePicker. The bottom catalogue continues to
// import `products` directly from catalogue.js and is intentionally unchanged.
export const visualizerProducts = [
  ...products,
